...
class Powerkit_Share_Buttons_Admin extends Powerkit_Module_Admin {
	...
	public function register_options_page() {
		$this->page_hook = add_submenu_page( powerkit_get_page_slug( 'manager' ), esc_html__( 'Share Buttons', 'powerkit' ), esc_html__( 'Share Buttons', 'powerkit' ), 'manage_options', powerkit_get_page_slug( $this->slug ), array( $this, 'build_options_page' ) );
	}
